# python sr.py --model checkpoints\testmodel_carn_adam_0.01\23.037924874789912_0.00458863637010966_500.pth --input result/Set14_monarch.png/2x/lr.png --output xxxyyy.png
